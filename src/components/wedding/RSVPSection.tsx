...
const RSVPSection = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      title: attending ? "We can't wait to see you! 🎉" : "We'll miss you! 💕",
  ...
  return (
    <section className="py-20 px-6 bg-card/30">
      <div className="max-w-lg mx-auto text-center">
        <p className="font-script text-primary text-3xl md:text-4xl mb-2 animate-fade-in-up">RSVP</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 animate-fade-in-up animation-delay-400">
          <div className="text-left">
            <label className="font-display text-sm tracking-wider uppercase text-foreground/70 mb-2 block">Your Name</label>
            <Input
              value={name}
          ...
          <div className="text-left">
            <label className="font-display text-sm tracking-wider uppercase text-foreground/70 mb-2 block">Number of Guests</label>
            <select
              value={guests}
          ...
          <div>
            <label className="font-display text-sm tracking-wider uppercase text-foreground/70 mb-3 block">Will you attend?</label>
            <div className="flex gap-3 justify-center">
              <Button
                type="button"
                variant={attending === true ? "default" : "outline"}
                className={`flex-1 font-display tracking-wider ${attending === true ? 'bg-primary' : 'border-primary/20 hover:bg-primary/10'}`}
              ...
              <Button
                ...
                className={`flex-1 font-display tracking-wider ${attending === false ? 'bg-primary' : 'border-primary/20 hover:bg-primary/10'}`}
